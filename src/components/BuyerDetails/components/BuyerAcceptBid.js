...
import { acceptFarmerBid,getBuyerProfile } from '../services/buyerService';
            ...
            <Card style={{width:'40rem',height:'15rem',borderRadius:'30px',opacity:1,backgroundColor:"rgb(212,212,212",marginTop:"15vh"}}>
                <Form onSubmit={handleSubmit} ref={form}>
                    <Card.Body>
                        ...
                        <strong>Are you sure, You want to accept the Bid for the Order ?</strong>  
                        </div>
                    </Card.Body>
                
                    <div style={{marginLeft:'10vw',marginTop:'3vh'}}>
                        <button className="btn btn-primary btn-block" style={{borderRadius:'50px',width:'110px',height:'39px'}}>Accept Bid</button>
                    </div>
