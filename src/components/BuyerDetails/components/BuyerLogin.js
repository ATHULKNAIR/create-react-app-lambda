                ...
                <Form onSubmit={handleLogin} ref={form}>
                    <div className="form-group">
                        ...
                        <Input type="text" className="form-control" name="phoneNo" value={phoneNo} placeholder="Mobile Number" 
                               onChange={onChangePhone} validations={[required]} style={{width:'16vw',marginLeft:'-3vw'}}/>
                    </div>
                    ...
                    <div style={{marginTop:'5vh', color:'#e5e5e5' , fontSize:'20px'}}> <p>New Customer? <a href="/buyer/register"  style={{ color:'#1FF1D0' }}>Register</a></p></div>
                </Form>
                <br/>
